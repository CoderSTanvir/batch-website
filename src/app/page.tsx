...
export default async function Home() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-8">
      {/* Hero */}
      <section className="rounded-xl border border-navy-light/40 bg-navy-accent/60 p-8 text-center">
        <Image
          src="/logo.jpeg"
          alt="Batch logo"
          width={72}
      ...
      {/* Alumni link */}
      <section className="mt-8 rounded-xl border border-navy-light/40 bg-navy-accent/60 p-5">
      ...
      <section className="mt-4 grid gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-navy-light/40 bg-navy-accent/60 p-5">
